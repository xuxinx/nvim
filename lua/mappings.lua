...
sm("n", "<leader>R", vim.lsp.buf.rename, { desc = "rename var" })
-- # diagnostic
...
-- # dap
sm("n", "<leader>bp", require("dap").toggle_breakpoint, { desc = "toggle debug breakpoint" })
sm("n", "<F4>", require("dap").terminate, { desc = "terminate debug" })
sm("n", "<F5>", require("dap").continue, { desc = "start or continue debug" })
sm("n", "<leader><F5>", require("x.dap").debug_test, { desc = "debug test" })
sm("n", "<F6>", require("dap").run_to_cursor, { desc = "debug run to cursor" })
