...
-- snip
sm({ "i", "s" }, "<C-h>", cb.snip_expand, { desc = "snippet expand" })
...
cac("FileType", { pattern = "netrw", callback = function ()
    sm("n", "<leader>tf", cb.netrw_create_test_file, { buffer = true, desc = "netrw - create test file" })
end })
